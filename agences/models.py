...
class Agences(models.Model):
    district = models.ForeignKey(District, verbose_name="Quartier *", null=True, on_delete=models.CASCADE)
...
class Vehicules(models.Model):
    user = models.ForeignKey(User, null=True, on_delete=models.CASCADE, verbose_name='Chauffeur')
    type = models.ForeignKey(TypeVehicules, on_delete=models.CASCADE, verbose_name='Type de véhicules *')
